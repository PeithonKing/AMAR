...
boardf.analog[0].enable_reporting()
boardf.analog[1].enable_reporting()
boardf.analog[2].enable_reporting()
boardf.analog[3].enable_reporting()
boardf.analog[4].enable_reporting()
boardf.analog[5].enable_reporting()

boardb.analog[0].enable_reporting()
boardb.analog[1].enable_reporting()
boardb.analog[2].enable_reporting()
boardb.analog[3].enable_reporting()
boardb.analog[4].enable_reporting()
boardb.analog[5].enable_reporting()
